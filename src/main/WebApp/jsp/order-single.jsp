                    ...
                    <c:forEach items="${dlist }" var="dlist">
                        <div class="col-sm-5">
                            <div class="pa-prod-thumb-img">
                                <img src="/imgUrl/product/${dlist.comImage }" alt="image" class="img-fluid"/>
                            </div>
                        </div>
                        <div class="col-sm-7">
	                            ...
	                            <div class="pa-prod-content">
	                                ...
	                                <h2 class="pa-prod-title">${dlist.comName }</h2>
	                                <p class="pa-prod-price">
	                                	<span>单价: </span> ￥${dlist.comPrice }
	                                	<span class="pa-offer-price">25% off</span>
	                                </p>
	                                <p>
	                                	<span>数量:</span>${dlist.comAmount }
	                                </p>
	                                <p>
	                                	<span>位置:</span> ${dlist.order.orderStatus }
	                                </p>
	                                <p>
	                                	<span>快递单号:</span> ${dlist.order.trackNum }
	                                </p>
	                                <p>
	                                	<span>快递公司:</span> ${dlist.order.courier }
	                                </p>
	                                <p class="pa-rating">
                        ...
                        <div class="col-md-12">    
                            <div class="pa-prod-content">
                                <div class="pa-prod-count">
                                    ...
                                    <a href="${pageContext.request.contextPath}/order/getOrderList"><button class="pa-btn">订单列表</button></a>
                                </div>
